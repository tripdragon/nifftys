...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qt,depthTest:!1,depthWrite:!1})}function Ws(){return new xn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Br(),fragmentShader:`
		...
		`,blending:Qt,depthTest:!1,depthWrite:!1})}function Xs(){return new xn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Br(),fragmentShader:`
